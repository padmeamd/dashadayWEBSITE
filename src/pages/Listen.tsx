...
const streamingPlatforms = [
  {
    name: "Spotify",
    url: "https://open.spotify.com/album/1ROwGXAQFQnqVBL0n3cI4E",
    icon: (
  ...
  {
    name: "Apple Music",
    url: "https://music.apple.com/us/album/things-i-shouldnt-say/6770379845",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Amazon Music",
    url: "https://music.amazon.co.uk/albums/B0H2471FPX",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Deezer",
    url: "https://www.deezer.com/en/album/985067481",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "YouTube Music",
    url: "https://music.youtube.com/playlist?list=OLAK5uy_k3BpYvBuVCdV4L8DMI62g5umR1sf7Y00U",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
